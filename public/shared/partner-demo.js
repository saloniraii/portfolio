...
(function () {
    ...
    function init() {
        ...
        root.innerHTML = `
            <div class="pd-container">
                <div class="pd-journey-tabs">
                    <button class="pd-journey-tab active" data-journey="partner-connect">Browse & Sync Leads</button>
                    <button class="pd-journey-tab" data-journey="pricing-quotes">Pricing & Quotes</button>
                    <button class="pd-journey-tab" data-journey="deal-registration">Deal Registration</button>
                </div>
    ...
    function bindEvents(root) {
        root.querySelectorAll('.pd-journey-tab').forEach(tab => {
            tab.addEventListener('click', () => {
                root.querySelectorAll('.pd-journey-tab').forEach(t => t.classList.remove('active'));
                tab.classList.add('active');
                currentJourney = tab.dataset.journey;

                const subTabs = document.getElementById('pdSubTabs');
                subTabs.style.display = currentJourney === 'partner-connect' ? 'flex' : 'none';
